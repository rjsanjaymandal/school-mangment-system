                        ...
                        <div className="flex items-baseline gap-x-3">
                            ...
                            <div
                                className={cn(
                                    ...
                                    p.trend === "up" ? "text-green-500" : p.trend === "down" ? "text-blue-500" : "text-yellow-500",
                                )}
                            >
                                {p.trend === "up" ? (
                ...
                <div className="space-y-6">
                    ...
                    <Card className="border-none glass futuristic-card p-6 border-yellow-100 bg-yellow-50/5">
                        ...
                        <p className="text-xs text-slate-500 font-medium leading-relaxed mb-6">
                            Current recorded revenue is ₹{(systemMetrics?.totalRevenue || 0).toFixed(2)}. Potential deficit forecasted in elective fees due to regional inflation telemetry.
                        </p>

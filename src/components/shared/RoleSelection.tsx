...
const roles = [
    ...
    },
    {
        id: "accountant",
        title: "Accounts",
        description: "Financial ledger management, fee collection, and payroll auditing.",
        icon: Wallet,
    ...
    },
    {
        id: "receptionist",
        title: "Front Office",
        description: "Institutional inquiries, visitor registration, and administrative support.",
        icon: Monitor,
            ...
            <div className="w-full max-w-6xl relative z-10 space-y-20 page-fade-in">
                ...
                <div className="text-center space-y-8 max-w-2xl mx-auto">
                    <div className="inline-flex items-center gap-x-3 px-4 py-1.5 rounded-full bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500">Gateway Access</span>
                    </div>
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-lg font-medium leading-relaxed">
                            A refined portal for academic excellence. Select your institutional workspace to proceed.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-y-6 pt-10">
                    ...
                    <p className="text-[10px] font-bold text-slate-300 dark:text-slate-700 uppercase tracking-[0.4em]">
                        Institutional Management System v4.5
                    </p>
                </div>
            </div>
        </div>

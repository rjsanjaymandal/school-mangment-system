...
const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Guardians", href: "/guardian", icon: Users, description: "Manage parent associations and directory records" },
      ...
      { name: "Conduct", href: "/conduct", icon: UserCheck, description: "Track conduct points, actions, and discipline logs" },
      { name: "Health", href: "/health", icon: Stethoscope, description: "Manage campus clinical logs and medical details" },
    ],
  },
  {
    group: "Staff",
  ...
  },
  {
    ...
    roles: ["admin", "teacher", "student"],
    items: [
      { name: "Classes", href: "/classes", icon: Users, roles: ["admin", "teacher"], description: "Configure class sections, limits, and levels" },
      { name: "Subjects", href: "/subjects", icon: BookOpen, roles: ["admin", "teacher"], description: "Define school subjects and syllabus guidelines" },
      { name: "Timetable", href: "/timetable", icon: Calendar, description: "General school timetable and period schedules" },
      { name: "Exams", href: "/exams", icon: FileText, roles: ["admin", "teacher"], description: "Exams dashboard, assessments, and score listings" },
      { name: "Online Exams", href: "/exams/online", icon: Globe, roles: ["admin", "teacher"], description: "Setup online computer-based tests and keys" },
      { name: "Gradebook", href: "/gradebook", icon: ClipboardCheck, description: "View student term marks, progress cards, and metrics" },
      { name: "Activities", href: "/activities", icon: Trophy, description: "Co-curricular activities list and logs" },
      { name: "Certificates", href: "/certificates", icon: Award, description: "Generate templates and print student award sheets" },
    ],
  },
  {
    group: "Finance",
    items: [
      ...
      { name: "Payment Gateways", href: "/gateways", icon: Wallet, description: "Manage online payment credentials and processing APIs" },
      ...
      { name: "Payroll Dashboard", href: "/payroll", icon: IndianRupee, roles: ["admin"], description: "Staff payroll, monthly salaries, and leave requests dashboard" },
  ...
  },
  {
    group: "Services",
    items: [
      { name: "Library", href: "/library", icon: Library, description: "Track library catalog, book issues, and returns" },
      { name: "Transport", href: "/transport", icon: Bus, description: "Manage bus route tracking, drivers, and fleets" },
      { name: "Inventory", href: "/inventory", icon: Package, roles: ["admin"], description: "Asset directory and inventory levels" },
      { name: "Alumni", href: "/heritage", icon: Award, description: "Graduates logs, outstanding achievements, and memories" },
    ],
  },
  {
    group: "System",

    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700 pb-12">
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <Card className="border-none glass futuristic-card p-6 border-red-500/20 bg-red-500/5">
                    <div className="flex justify-between items-start mb-4">
                        <AlertCircle className="h-8 w-8 text-red-500" />
                        <Badge
                            className="bg-red-500 text-white border-none rounded-xl text-[10px] uppercase font-black tracking-widest"
                        >
                            IMMEDIATE
                        </Badge>
                    </div>
                ...
                <Card className="border-none glass futuristic-card p-6">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <Badge
                            variant="outline"
                            className="bg-blue-500/10 text-blue-500 border-blue-500/20 rounded-xl text-[10px] uppercase font-black tracking-widest"
                        >
                            PENDING
                        </Badge>
                    </div>
                ...
                <Card className="border-none glass futuristic-card p-6 bg-slate-900 text-white shadow-xl shadow-slate-900/20">
                    <div className="flex justify-between items-start mb-4">
                        <ShoppingCart className="h-8 w-8 text-blue-400" />
                        <Badge
                            className="bg-blue-500 text-white border-none rounded-xl text-[10px] uppercase font-black tracking-widest"
                        >
                            ACTIVE
                        </Badge>
                    </div>
                                            ...
                                            <td className="p-5">
                                                <div className="w-32 space-y-2">
                                                    <div className="flex justify-between text-[10px] font-bold">
                                                        <span>{item.quantity_in_stock} units</span>
                                                        <span
                                                            className={cn(
                                                    ...
                                                    <Progress
                                                        value={Math.min((item.quantity_in_stock / 100) * 100, 100)}
                                                        className="h-1"
                                                        indicatorClassName={
                                                            item.quantity_in_stock < 20
                                                                ? "bg-red-500"

                ...
                <div className="md:col-span-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-10 rounded-xl relative overflow-hidden group">
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="mb-8 flex justify-between items-start">
                            <div>
                                <h3 className="text-2xl font-black uppercase tracking-tighter text-slate-900 dark:text-white group-hover:text-emerald-600 transition-colors">
            ...
            <div className="grid gap-8 lg:grid-cols-3">
                <div className="lg:col-span-2 space-y-6">
                    <div className="flex items-center justify-between">
                        <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 flex items-center gap-x-3">
                        ...
                        <div className="relative w-64">
                            ...
                            <Input
                                ...
                                className="pl-9 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 h-10 text-xs font-bold text-slate-700 dark:text-slate-300 placeholder:text-slate-400 dark:placeholder:text-slate-500"
                                value={searchTerm}
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-slate-100 dark:border-slate-800">
                                        <th className="text-left py-4 px-4 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Reference Number</th>
                                        ...
                                        <th className="text-right py-4 px-4 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Operations</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {filteredCertificates.map((cert) => (
                                        <tr key={cert.id} className="hover:bg-slate-50 dark:hover:bg-slate-900 border-b border-slate-100 dark:border-slate-800 transition-colors group">
                                            <td className="py-4 px-4">
                                                <div className="flex items-center gap-x-3">
                                                    <div className="h-12 w-12 rounded-xl bg-emerald-50 dark:bg-emerald-950/20 flex items-center justify-center border border-emerald-100 dark:border-emerald-900/30 transition-all group-hover:scale-110">
                                                        <Award className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />
                                                    </div>
                                                    <div>
                                                        <p className="font-bold text-slate-900 dark:text-white group-hover:text-emerald-600 transition-colors uppercase tracking-tight text-sm">
                                                ...
                                                <div className="flex justify-end gap-x-2">
                                                    ...
                                                    {isAdminOrTeacher && (
                                                        <button
                                                            ...
                                                            className="h-9 w-9 rounded-lg border border-slate-200 dark:border-slate-800 text-slate-400 hover:text-rose-600 hover:border-rose-200 transition-all flex items-center justify-center"
                                                        >
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="aspect-[1.414/1] w-full bg-slate-50 dark:bg-slate-950 shadow-2xl border-[12px] border-emerald-100 relative overflow-hidden flex flex-col items-center justify-center p-6 text-center group transition-all hover:border-emerald-200">
                                <div className="absolute inset-0 opacity-5 pointer-events-none flex items-center justify-center">
                                    <GraduationCap className="h-32 w-32 text-slate-800 dark:text-slate-200" />
                                </div>
                                <Award className="h-8 w-8 text-slate-800 dark:text-slate-200 mb-2" />
                                <h2 className="text-lg font-serif text-slate-900 dark:text-white leading-tight">Certificate of Achievement</h2>
                                <p className="text-[6px] tracking-widest text-slate-500 dark:text-slate-400 uppercase mt-2 mb-4">Awarded To</p>
                                <h3 className="text-xl font-black text-slate-900 dark:text-white mb-4 uppercase">STUDENT NAME</h3>
                                <div className="absolute bottom-4 left-4 right-4 flex justify-between border-t border-slate-200 dark:border-slate-800 pt-2">
                                    ...
                                    <div className="h-6 w-6 rounded-sm border border-slate-900 flex items-center justify-center -mt-2 bg-white dark:bg-slate-900 relative z-10 shadow-lg">
                    ...
                    <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 text-slate-900 dark:text-white p-6 relative overflow-hidden group rounded-xl">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:scale-110 transition-transform">
                            <BookOpen className="h-16 w-16 text-emerald-600 dark:text-emerald-400" />
                        </div>
                        <h4 className="text-sm font-black tracking-tight mb-2 uppercase text-emerald-700 dark:text-emerald-400">
                            Secure Records
                        </h4>
                        <p className="text-xs text-slate-600 dark:text-slate-400 font-bold leading-relaxed uppercase tracking-tighter">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md p-6 mx-4">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                <h3 className="text-lg font-black tracking-tight text-slate-900 dark:text-white">Issue Certificate</h3>
                            ...
                            <button onClick={() => setShowIssueModal(false)} className="h-8 w-8 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-slate-600">&times;</button>
                        </div>
                        <form onSubmit={handleIssue} className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Student</label>
                                <select name="student_id" required className="w-full h-11 rounded-xl border border-slate-200 dark:border-slate-800 px-3 text-sm font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 focus:border-blue-300 outline-none">
                                    <option value="" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Select Student...</option>
                                    {students.map((s) => (<option key={s.id} value={s.id} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">[{s.admission_number}] {s.profile?.first_name} {s.profile?.last_name}</option>))}
                                </select>
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Certificate Type</label>
                                <select name="type" required className="w-full h-11 rounded-xl border border-slate-200 dark:border-slate-800 px-3 text-sm font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 focus:border-blue-300 outline-none">
                                    <option value="" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Select Type...</option>
                                    <option value="Academic Excellence" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Academic Excellence</option>
                                    <option value="Athletic Achievement" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Athletic Achievement</option>
                                    <option value="Conduct & Leadership" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Conduct & Leadership</option>
                                    <option value="Special Commendation" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Special Commendation</option>
                                </select>
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Notes</label>
                                <input name="notes" placeholder="Reason for issuing..." className="w-full h-11 rounded-xl border border-slate-200 dark:border-slate-800 px-3 text-sm font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-blue-300 outline-none" />
                            </div>

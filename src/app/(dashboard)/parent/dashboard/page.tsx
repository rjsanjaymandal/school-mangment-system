    ...
    <div className="p-6 space-y-6 animate-in fade-in duration-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden">
              <div className="p-5 border-b border-slate-100 dark:border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Student Information</h3>
                </div>
              </div>
              <div className="p-5">
                <div className="flex items-center gap-4">
                  <div className="h-14 w-14 rounded-full bg-blue-100 dark:bg-blue-950/35 flex items-center justify-center text-blue-600 dark:text-blue-400 font-black text-xl">
                    {student.profile?.full_name?.charAt(0) || "S"}
                  </div>
                  <div>
                    <h3 className="text-lg font-black tracking-tight text-slate-900 dark:text-white">{student.profile?.full_name}</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Adm No: {student.admission_number}</p>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Class: {student.class?.name}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden p-5">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">{presentDays}/{recentAttendance.length} days present</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden p-5">
          ...
          <p className="text-lg font-black tracking-tight text-slate-900 dark:text-white">Active</p>
        ...
        <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden p-5">
          ...
          <p className="text-lg font-black tracking-tight text-slate-900 dark:text-white">Parent-Teacher</p>
          <p className="text-xs text-slate-500 dark:text-slate-400">Contact school for date</p>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden">
          <div className="p-5 border-b border-slate-100 dark:border-white/10">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Pending Fee Dues</h3>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-slate-50/50 dark:bg-white/[0.04]">
                <tr>
                  ...
                  <th className="text-right p-4 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Amount</th>
                  <th className="text-center p-4 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">Status</th>
                </tr>
              </thead>
              <tbody>
                {feeDues.map(fee => (
                  <tr key={fee.id} className="border-b border-slate-100 dark:border-white/10 hover:bg-slate-50/50 dark:hover:bg-white/[0.06]">
                    ...
                    <td className="p-4 text-center">
                      <span className="px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest bg-amber-50 text-amber-600 dark:bg-amber-950/20 dark:text-amber-400">Pending</span>
                    </td>
                  </tr>
                ))}
              </tbody>
